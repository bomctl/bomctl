...
func (pu *PersonUpdate) SetPersonID(id int) *PersonUpdate {
...
func (pu *PersonUpdate) SetNillablePersonID(id *int) *PersonUpdate {
	if id != nil {
...
func (pu *PersonUpdate) SetPerson(p *Person) *PersonUpdate {
	return pu.SetPersonID(p.ID)
}

// SetContactsID sets the "contacts" edge to the Person entity by ID.
func (pu *PersonUpdate) SetContactsID(id int) *PersonUpdate {
	pu.mutation.SetContactsID(id)
	return pu
}

// SetNillableContactsID sets the "contacts" edge to the Person entity by ID if the given value is not nil.
func (pu *PersonUpdate) SetNillableContactsID(id *int) *PersonUpdate {
	if id != nil {
		pu = pu.SetContactsID(*id)
	}
	return pu
}

// SetContacts sets the "contacts" edge to the Person entity.
func (pu *PersonUpdate) SetContacts(p *Person) *PersonUpdate {
	return pu.SetContactsID(p.ID)
}
...
func (pu *PersonUpdate) ClearPerson() *PersonUpdate {
...
func (pu *PersonUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if pu.mutation.PersonCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{person.PersonColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetPersonID sets the "person" edge to the Person entity by ID.
func (puo *PersonUpdateOne) SetPersonID(id int) *PersonUpdateOne {
	puo.mutation.SetPersonID(id)
	return puo
}

// SetNillablePersonID sets the "person" edge to the Person entity by ID if the given value is not nil.
func (puo *PersonUpdateOne) SetNillablePersonID(id *int) *PersonUpdateOne {
	if id != nil {
...
// SetPerson sets the "person" edge to the Person entity.
func (puo *PersonUpdateOne) SetPerson(p *Person) *PersonUpdateOne {
	return puo.SetPersonID(p.ID)
}

// SetContactsID sets the "contacts" edge to the Person entity by ID.
func (puo *PersonUpdateOne) SetContactsID(id int) *PersonUpdateOne {
	puo.mutation.SetContactsID(id)
	return puo
}

// SetNillableContactsID sets the "contacts" edge to the Person entity by ID if the given value is not nil.
func (puo *PersonUpdateOne) SetNillableContactsID(id *int) *PersonUpdateOne {
	if id != nil {
		puo = puo.SetContactsID(*id)
	}
	return puo
}

// SetContacts sets the "contacts" edge to the Person entity.
func (puo *PersonUpdateOne) SetContacts(p *Person) *PersonUpdateOne {
	return puo.SetContactsID(p.ID)
}
...
// ClearPerson clears the "person" edge to the Person entity.
func (puo *PersonUpdateOne) ClearPerson() *PersonUpdateOne {
