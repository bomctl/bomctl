...
func (eru *ExternalReferenceUpdate) AddNodeIDs(ids ...string) *ExternalReferenceUpdate {
...
func (eru *ExternalReferenceUpdate) RemoveNodeIDs(ids ...string) *ExternalReferenceUpdate {
...
// AddNodeIDs adds the "nodes" edge to the Node entity by IDs.
func (eruo *ExternalReferenceUpdateOne) AddNodeIDs(ids ...string) *ExternalReferenceUpdateOne {
...
// RemoveNodeIDs removes the "nodes" edge to Node entities by IDs.
func (eruo *ExternalReferenceUpdateOne) RemoveNodeIDs(ids ...string) *ExternalReferenceUpdateOne {
