...
func (pq *PersonQuery) QueryPerson() *PersonQuery {
...
func (pq *PersonQuery) WithPerson(opts ...func(*PersonQuery)) *PersonQuery {
	query := (&PersonClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (pq *PersonQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Person, error) {
	...
	if pq.withMetadata != nil || pq.withNode != nil || pq.withPerson != nil {
		withFKs = true
	}
	if withFKs {
	...
	if query := pq.withMetadata; query != nil {
		if err := pq.loadMetadata(ctx, query, nodes, nil,
			func(n *Person, e *Metadata) { n.Edges.Metadata = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := pq.withPerson; query != nil {
		if err := pq.loadPerson(ctx, query, nodes, nil,
			func(n *Person, e *Person) { n.Edges.Person = e }); err != nil {
			return nil, err
		}
	}
	if query := pq.withContacts; query != nil {
		if err := pq.loadContacts(ctx, query, nodes, nil,
			func(n *Person, e *Person) { n.Edges.Contacts = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *PersonQuery) loadPerson(ctx context.Context, query *PersonQuery, nodes []*Person, init func(*Person), assign func(*Person, *Person)) error {
