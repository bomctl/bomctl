...
func (pc *PersonCreate) SetPersonID(id int) *PersonCreate {
...
func (pc *PersonCreate) SetNillablePersonID(id *int) *PersonCreate {
	if id != nil {
...
func (pc *PersonCreate) SetPerson(p *Person) *PersonCreate {
	return pc.SetPersonID(p.ID)
}

// SetContactsID sets the "contacts" edge to the Person entity by ID.
func (pc *PersonCreate) SetContactsID(id int) *PersonCreate {
	pc.mutation.SetContactsID(id)
	return pc
}

// SetNillableContactsID sets the "contacts" edge to the Person entity by ID if the given value is not nil.
func (pc *PersonCreate) SetNillableContactsID(id *int) *PersonCreate {
	if id != nil {
		pc = pc.SetContactsID(*id)
	}
	return pc
}

// SetContacts sets the "contacts" edge to the Person entity.
func (pc *PersonCreate) SetContacts(p *Person) *PersonCreate {
	return pc.SetContactsID(p.ID)
}
